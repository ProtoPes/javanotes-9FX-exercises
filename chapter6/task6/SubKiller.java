 ...
 * On the top number of hits and misses are shown.
 */
public class SubKiller extends Application {
    ...
    private int misses;         // Counter for misses.
    
    private Canvas canvas;      // The canvas where everything is drawn.
    
    private Label hitsMessage;
    private Label missMessage;
    ...
    public void start(Stage stage) {
        ...
        /* Set up the GUI */
        hitsMessage = new Label("Hits: " + hits);
        missMessage = new Label("Misses: " + misses);
        Font font = new Font(20);
        hitsMessage.setFont(font);
        missMessage.setFont(font);
        HBox box = new HBox(100, hitsMessage, missMessage);
        ...
        void updateForNewFrame() {  // If bomb is falling, take appropriate action.
            if (isFalling) {
                if (centerY > height) {
                    ...
                    misses++;
                    missMessage.setText("Misses: " + misses);
                    isFalling = false;
                }
